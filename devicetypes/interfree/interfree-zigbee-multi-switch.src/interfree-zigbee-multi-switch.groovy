 ...
 *  under the License.
 *
 *  author : Rana Afzal, Moe 
 */
public static String version() { return "v0.0.10.20220630" }
...
metadata {
    definition(name: "Interfree ZigBee Multi Switch", namespace: "Interfree", author: "Rana Afzal, Moe", ocfDeviceType: "oic.d.switch", vid: "generic-switch") {
        capability "Actuator"
        ...
        // Interfree 1, 2, 3 and 4 gang switches
		fingerprint endpointId: "10", profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Interfree", model: "XSSW1O", deviceJoinName: "Interfree 1 Gang X1"// 1K
		fingerprint endpointId: "10", profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Interfree", model: "XSSW2O", deviceJoinName: "Interfree 2 Gang X1"// 2K
        fingerprint endpointId: "10", profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Interfree", model: "XSSW3O", deviceJoinName: "Interfree 3 Gang X1"//3K
        fingerprint endpointId: "10", profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Interfree", model: "XSSW4O", deviceJoinName: "Interfree 4 Gang X1"//4K
         
        fingerprint endpointId: "10", profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Interfree", model: "UPUSK1O", deviceJoinName: "Interfree Socket U1B"// 1K SOCKET
        fingerprint endpointId: "10", profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Interfree", model: "UPSK2O", deviceJoinName: "Interfree Socket U1"// 2K SOCKET
